...
function createEnv(opts) {
  ...
  const parsed = ((_a = opts.createFinalSchema) == null ? void 0 : _a.call(opts, finalSchemaShape, isServer)["~standard"].validate(runtimeEnv)) ?? parseWithDictionary(finalSchemaShape, runtimeEnv);
